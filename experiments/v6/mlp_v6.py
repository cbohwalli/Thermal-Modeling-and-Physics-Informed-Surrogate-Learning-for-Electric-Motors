...
plt.tight_layout()
plt.savefig('ground_truth_vs_predictions_mlp_v6.png')
print("Plot saved as ground_truth_vs_predictions_mlp_v6.png")
...
plt.legend()
plt.grid(True)
plt.savefig('training_loss_curve_mlp_v6.png')
print("Plot saved as training_loss_curve_mlp_v6.png")